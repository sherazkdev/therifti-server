...
class ChatServices {
    ...
    async CreateChat(chatObject) {
        ...
        if (oldChatDocument)
            throw new ApiError(STATUS_CODES.BAD_REQUEST, ERROR_MESSAGES.CHAT.ALREADY_EXIST);
    ...
    */
    async CheckChatByMembers(members) {
    ...
    async DeleteChat(chatId) {
        ...
        if (!chatDocument)
            throw new ApiError(STATUS_CODES.NOT_FOUND, ERROR_MESSAGES.CHAT.CHAT_NOT_FOUND);
