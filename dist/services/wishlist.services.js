...
class WishlistServices {
    ...
    */
    async AddToWishlist(wishlistObject) {
        ...
        if (check_wishlist)
            throw new ApiError(STATUS_CODES.BAD_REQUEST, ERROR_MESSAGES.WISHLIST.ALREADY_EXIST);
