...
class CategoryServices {
    ...
    */
    async CreateCategory(categoryObject) {
        ...
        if (category)
            throw new ApiError(STATUS_CODES.UNAUTHORIZED, ERROR_MESSAGES.CATEGORY.ALREADY_EXIST);
    ...
    */
    async UpdateCategory(updateCategoryData) {
        ...
        if (parent)
            category.parent = new mongoose.Types.ObjectId(parent);
        await category.save();
        return category;
    }
    ;
    ...
    */
    BuildCategoriesTree(parent, descendants) {
    ...
    */
    async DeleteCategory(categoryId) {
        ...
        const category = await CategoryModel.findById(new mongoose.Types.ObjectId(categoryId));
        if (!category)
            throw new ApiError(STATUS_CODES.UNAUTHORIZED, ERROR_MESSAGES.CATEGORY.NOT_FOUND);
