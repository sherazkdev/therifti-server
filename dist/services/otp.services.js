...
import fs from "fs";
/** Otp Interfaces */
import { OTP_EMAIL_CONTENT } from "../interfaces/otp.interfaces.js";
/** Note: Mail Services. */
...
class OtpServices {
    ...
    */
    async GetTemplatePath(templateObject) {
        const { filename } = templateObject;
        const templatePath = path.join(__dirname, `../configs/nodemailer/templates`, `${filename}`);
