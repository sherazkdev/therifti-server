...
class FollowServices {
     ...
     * });
    */
    async FollowSeller(followObject) {
        ...
        if (follower_exist)
            throw new ApiError(STATUS_CODES.BAD_REQUEST, ERROR_MESSAGES.FOLLOW.ALREADY_EXIST);
     ...
     * });
    */
    async UnFollowSeller(followObject) {
        const { followerId, followingId } = followObject;
        ...
        if (!followDocument)
            throw new ApiError(STATUS_CODES.BAD_REQUEST, ERROR_MESSAGES.FOLLOW.NOT_FOUND);
