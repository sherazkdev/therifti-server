...
class WishlistControllers {
     ...
     */
    HandleAddToWishlist = async (req, res) => {
        ...
        return res.status(STATUS_CODES.ACCEPTED).json(new ApiResponse([], SUCCESS_MESSAGES.WISHLIST.ADDED, true, STATUS_CODES.ACCEPTED));
    };
    /**
     ...
     */
    HandleRemoveToWishlist = async (req, res) => {
        ...
        return res.status(STATUS_CODES.ACCEPTED).json(new ApiResponse([], SUCCESS_MESSAGES.WISHLIST.REMOVED, true, STATUS_CODES.ACCEPTED));
    };
    /**
     ...
     */
    HandleGetWishlists = async (req, res) => {
        const wishlistDocuments = await this.wishlistServices.GetWishlists(req.user._id.toString());
        return res.status(STATUS_CODES.OK).json(new ApiResponse(wishlistDocuments, SUCCESS_MESSAGES.WISHLIST.FETCHED, true, STATUS_CODES.OK));
    };
}
