...
class CategoryControllers {
    ...
    HandleCreateCategory = async (req, res) => {
        ...
        return res.status(STATUS_CODES.ACCEPTED).json(new ApiResponse([], SUCCESS_MESSAGES.CATEGORY.CREATED, true, STATUS_CODES.ACCEPTED));
    };
    /**
    ...
    HandleUpdateCategory = async (req, res) => {
        ...
        return res.status(STATUS_CODES.ACCEPTED).json(new ApiResponse([], SUCCESS_MESSAGES.CATEGORY.UPDATED, true, STATUS_CODES.ACCEPTED));
    };
    /**
    ...
    HandleDeleteCategory = async (req, res) => {
        ...
        return res.status(STATUS_CODES.ACCEPTED).json(new ApiResponse([], SUCCESS_MESSAGES.CATEGORY.DELETED, true, STATUS_CODES.ACCEPTED));
    };
    /**
    ...
    HandleGetCategories = async (req, res) => {
        ...
        return res.status(STATUS_CODES.OK).json(new ApiResponse(categoryDocuments, SUCCESS_MESSAGES.CATEGORY.FETCH, true, STATUS_CODES.OK));
    };
}
export default CategoryControllers;
//# sourceMappingURL=category.controlles.js.map