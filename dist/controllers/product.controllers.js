...
class ProductControllers {
    ...
    */
    HandleCreateProduct = async (req, res) => {
        ...
        return res.status(STATUS_CODES.CREATED).json(new ApiResponse([], SUCCESS_MESSAGES.PRODUCT.CREATE, true, STATUS_CODES.CREATED));
    };
    /**
    ...
    */
    HandleSearchProduct = async (req, res) => {
        ...
        const searchProductPayload = { ...result.data, userId: req.user._id.toString() };
        const searchResultDocuments = await this.productServices.SearchProduct(searchProductPayload);
        return res.status(STATUS_CODES.OK).json(new ApiResponse(searchResultDocuments, SUCCESS_MESSAGES.PRODUCT.FETCH, true, STATUS_CODES.OK));
    };
    /**
    ...
    */
    HandleUpdateProduct = async (req, res) => {
        ...
        return res.status(STATUS_CODES.ACCEPTED).json(new ApiResponse([], SUCCESS_MESSAGES.PRODUCT.UPDATE, true, STATUS_CODES.ACCEPTED));
    };
    /**
    ...
    */
    HandleGetFeaturedProducts = async (req, res) => {
        ...
        return res.status(STATUS_CODES.OK).json(new ApiResponse(featuredProductsDocuments, SUCCESS_MESSAGES.PRODUCT.FETCH, true, STATUS_CODES.OK));
    };
    /**
    ...
    */
    HandleGetSingleProductById = async (req, res) => {
        ...
        return res.status(STATUS_CODES.OK).json(new ApiResponse(singleProductDocument, SUCCESS_MESSAGES.PRODUCT.FETCH, true, STATUS_CODES.OK));
    };
}
