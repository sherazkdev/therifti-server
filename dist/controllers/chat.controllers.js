...
class ChatControllers {
    ...
    HandleCreateChat = async (req, res) => {
        ...
        return res.status(STATUS_CODES.CREATED).json(new ApiResponse(chatDocument, SUCCESS_MESSAGES.CHAT.CHAT_CREATED, true, STATUS_CODES.CREATED));
    };
    /**
     * Note: Get Chats
     *
    ...
    HandleGetChat = async (req, res) => {
        ...
        return res.status(STATUS_CODES.OK).json(new ApiResponse(chatDocuments, SUCCESS_MESSAGES.CHAT.FETCHED, true, STATUS_CODES.OK));
    };
    /**
     * Note: Delete Chat
     *
    ...
    HandleDeleteChat = async (req, res) => {
        ...
        return res.status(STATUS_CODES.ACCEPTED).json(new ApiResponse([], SUCCESS_MESSAGES.CHAT.DELETED, true, STATUS_CODES.ACCEPTED));
    };
}
