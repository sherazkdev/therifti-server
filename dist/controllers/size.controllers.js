...
class SizeControllers {
    ...
    */
    HandleCreateSize = async (req, res) => {
        ...
        return res.status(STATUS_CODES.OK).json(new ApiResponse(sizeDocument, SUCCESS_MESSAGES.SIZE.CREATED, true, STATUS_CODES.OK));
    };
    /**
    ...
    */
    HandleGetSizeByCategory = async (req, res) => {
        ...
        return res.status(STATUS_CODES.OK).json(new ApiResponse(sizes, SUCCESS_MESSAGES.SIZE.FETCHED, true, STATUS_CODES.OK));
    };
    /**
    ...
    */
    HandleUpdateSize = async (req, res) => {
        ...
        return res.status(STATUS_CODES.OK).json(new ApiResponse(updatedDocument, SUCCESS_MESSAGES.SIZE.UPDATED, true, STATUS_CODES.OK));
    };
    /**
     ...
     * @throws {ApiError} If Size document does not exist.
    */
    HandleDeleteSize = async (req, res) => {
        ...
        return res.status(STATUS_CODES.OK).json(new ApiResponse(null, SUCCESS_MESSAGES.SIZE.DELETED, true, STATUS_CODES.OK));
    };
}
export default SizeControllers;
//# sourceMappingURL=size.controllers.js.map