...
export const ERROR_CODES = {
  ...
  USER: {
    ...
    USERID_OR_EMAIL_REQUIRED: "USERID_OR_EMAIL_REQUIRED",
    ACCOUNT_DEACTIVATE_LIVE_PRODUCTS: "ACCOUNT_DEACTIVATE_LIVE_PRODUCTS"
  },

  FOLLOW: {
    FOLLOWED: "FOLLOW_SUCCESS",
    UNFOLLOWED: "UNFOLLOW_SUCCESS",
    NOT_FOUND: "FOLLOWER_NOT_FOUND",
    ALREADY_EXIST: "FOLLOW_ALREADY_EXIST"
  },
  ...
  PRODUCT: {
    ...
    ALREADY_SOLD: "PRODUCT_ALREADY_SOLD",
    NOT_OWNER: "PRODUCT_NOT_OWNER"
  },

  CATEGORY: {
    NOT_FOUND: "CATEGORY_NOT_FOUND",
    ALREADY_EXIST: "CATEGORY_ALREADY_EXIST",
    DELETE_WITH_PRODUCTS: "CATEGORY_DELETE_WITH_PRODUCTS"
  },

  SIZE: {
    NOT_FOUND: "SIZE_NOT_FOUND",
    ALREADY_EXIST: "SIZE_ALREADY_EXIST"
  },

  BRAND: {
    NOT_FOUND: "BRAND_NOT_FOUND",
    ALREADY_EXIST: "BRAND_ALREADY_EXIST"
  },
  ...
  PAYMENT: {
    ...
    INVALID_METHOD: "PAYMENT_INVALID_METHOD",
    ALREADY_PAID: "PAYMENT_ALREADY_PAID"
  },

  SHIPPING: {
    NOT_AVAILABLE: "SHIPPING_NOT_AVAILABLE"
  },
  ...
  CHAT: {
    ...
    ALREADY_EXIST: "CHAT_ALREADY_EXIST",
    MESSAGE_FAILED: "CHAT_MESSAGE_FAILED"
  },

  WISHLIST: {
    NOT_FOUND: "WISHLIST_NOT_FOUND",
    ALREADY_EXIST: "WISHLIST_ALREADY_EXIST",
    CREATE_FAILED: "WISHLIST_CREATE_FAILED",
    REMOVE_FAILED: "WISHLIST_REMOVE_FAILED"
  },

  MATERIAL: {
    NOT_FOUND: "MATERIAL_NOT_FOUND",
    ALREADY_EXIST: "MATERIAL_ALREADY_EXIST",
    CREATE_FAILED: "MATERIAL_CREATE_FAILED",
    UPDATE_FAILED: "MATERIAL_UPDATE_FAILED",
    DELETE_FAILED: "MATERIAL_DELETE_FAILED"
  },

  PROMOTION: {
    ALREADY_ACTIVE: "PROMOTION_ALREADY_ACTIVE",
    PAYMENT_REQUIRED: "PROMOTION_PAYMENT_REQUIRED"
  },

  BUNDLE: {
    INVALID_ITEMS: "BUNDLE_INVALID_ITEMS",
    CREATE_FAILED: "BUNDLE_CREATE_FAILED"
  },

  DONATION: {
    FAILED: "DONATION_FAILED",
    INVALID_AMOUNT: "DONATION_INVALID_AMOUNT",
    SUBSCRIPTION_STARTED: "DONATION_SUBSCRIPTION_STARTED",
    SUBSCRIPTION_CANCELLED: "DONATION_SUBSCRIPTION_CANCELLED"
  },

  ADMIN: {
    ACTION_FAILED: "ADMIN_ACTION_FAILED"
  },
  ...
  COMMON: {
    SOMETHING_WENT_WRONG: "COMMON_ERROR",
